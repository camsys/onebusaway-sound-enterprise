...
default_attributes({
                     "oba" => {
                       ...
                       "mvn" => {
                           ...
                           "version_admin" => "2.0.75.4-cs",
                           "version_twilio" => "2.0.75.4-cs",
                           "version_core" => "2.0.75.4-cs",
                           "version_app" => "2.0.75.5-cs",
                           "version_branded" => "2.0.75.5-cs",
                           "version_transitime_core" => "0.0.49",
                           "version_transitime_web" => "0.0.49",
                           "version_shuttle_transitime_core" => "2.0.46.4-cs",
                           "version_shuttle_transitime_web" => "2.0.46.4-cs",
