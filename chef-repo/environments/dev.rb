...
default_attributes({
                     "oba" => {
                       ...
                       "mvn" => {
                           ...
                           "version_admin" => "2.0.25-cs-SNAPSHOT",
                           "version_twilio" => "2.0.25-cs-SNAPSHOT",
                           "version_core" => "2.0.25-cs-SNAPSHOT",
                           "version_app" => "2.0.25-cs-SNAPSHOT",
                           "version_branded" => "2.0.25-cs-SNAPSHOT",
