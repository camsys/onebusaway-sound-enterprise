...
default_attributes({
                     "oba" => {
                       ...
                       "mvn" => {
                           ...
                           "version_admin" => "2.0.79-cs-SNAPSHOT",
                           "version_twilio" => "2.0.79-cs-SNAPSHOT",
                           "version_core" => "2.0.79-cs-SNAPSHOT",
                           "version_app" => "2.0.79-cs-SNAPSHOT",
                           "version_branded" => "2.0.76-cs-SNAPSHOT",
                           "version_transitime_core" => "0.0.43-SNAPSHOT",
                           "version_transitime_web" => "0.0.43-SNAPSHOT",
                           "version_shuttle_transitime_core" => "2.0.47-cs-SNAPSHOT",
                           "version_shuttle_transitime_web" => "2.0.47-cs-SNAPSHOT",
