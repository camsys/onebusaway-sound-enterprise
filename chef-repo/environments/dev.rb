...
default_attributes({
                     "oba" => {
                       ...
                       "mvn" => {
                           ...
                           "version_admin" => "2.0.0-cs-rc17-SNAPSHOT",
                           "version_core" => "2.0.0-cs-rc17-SNAPSHOT",
                           "version_app" => "2.0.0-cs-rc17-SNAPSHOT",
                           "version_branded" => "2.0.0-cs-rc17-SNAPSHOT",
                           "version_transitime_core" => "0.0.33-SNAPSHOT",
                           "version_transitime_web" => "0.0.33-SNAPSHOT",
