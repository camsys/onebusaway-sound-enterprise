...
default_attributes({
                     "oba" => {
                       ...
                       "mvn" => {
                           ...
                           "version_admin" => "1.1.15.10-cs-SNAPSHOT",
                           "version_core" => "1.1.15.10-cs-SNAPSHOT",
                           "version_app" => "1.1.15.10-cs-SNAPSHOT",
                           "version_transitime_core" => "0.0.10-SNAPSHOT",
                           "version_transitime_web" => "0.0.10-SNAPSHOT",
                     ...
                     "transitime" => {
                        ...
                        "dbrohost" => "db.dev.wmata.obaweb.org:3306",
                        "dbtype" => "mysql",
