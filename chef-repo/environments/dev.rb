...
default_attributes({
                     "oba" => {
                       ...
                       "mvn" => {
                           ...
                           "version_admin" => "1.1.15.28-cs-SNAPSHOT",
                           "version_core" => "1.1.15.28-cs-SNAPSHOT",
                           "version_app" => "1.1.15.28-cs-SNAPSHOT",
                           "version_branded" => "1.1.15.28-cs-SNAPSHOT",
                           "version_transitime_core" => "0.0.28-SNAPSHOT",
                           "version_transitime_web" => "0.0.28-SNAPSHOT",
