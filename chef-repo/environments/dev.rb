...
default_attributes({
                     "oba" => {
                       ...
                       "mvn" => {
                           ...
                           "version_admin" => "1.1.15.30-cs-SNAPSHOT",
                           "version_core" => "1.1.15.30-cs-SNAPSHOT",
                           "version_app" => "1.1.15.30-cs-SNAPSHOT",
                           "version_branded" => "1.1.15.30-cs-SNAPSHOT",
                           "version_transitime_core" => "0.0.30-SNAPSHOT",
                           "version_transitime_web" => "0.0.30-SNAPSHOT",
                     ...
                     "transitime" => {
                        ...
                        "xsqsUrl" => "https://sqs.us-east-1.amazonaws.com/744689548994/obawmata_dev",
                        "xsqsKey" => "AKIAIR7AIWS2STDBINAQ",
                        "xsqsSecret" => "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",
